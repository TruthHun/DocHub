...
(/** @lends <global> */function( $ ) {
	 ...
	 * alignment.
	 *
	 * Welcome to the most horrible function DataTables. The procedure that this
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		 ...
		 * procedure in DataTables, then we can use the offsets that are created by
	 ...
	 * `pop`, `reverse` etc) as well as additional tools methods (`each`, `pluck`,
	...
	DataTable.defaults = {
		...
		/**
		 * This function allows you to 'post procedure' each row after it have been
		 ...
		 *    procedure that will draw the data on the page.
		 *  @param {object} settings DataTables settings object
		 *
		 *  @dtopt Callbacks
		 *  @dtopt Server-side
		 ...
		 *       <ul>
		 *         <li>'H' - jQueryUI theme "header" classes ('fg-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-tools-clearfix')</li>
		 *         <li>'F' - jQueryUI theme "footer" classes ('fg-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-tools-clearfix')</li>
		 *       </ul>
		 *     </li>
	...
	var _headerFooter = _empty + 'fg-toolbar ui-toolbar ui-widget-header ui-tools-clearfix';
	 ...
	 * procedure the data returned from the server, if needed.
	 *
	 ...
	 *
	 *  @example
	 *     // Pre-procedure the data returned from the server
	 *     $('#table').dataTable().on('xhr.dt', function (e, settings, json) {
