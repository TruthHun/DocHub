...
$.widget( "ui.button", {
	...
	_determineButtonType: function() {
		...
		if ( this.type === "checkbox" || this.type === "radio" ) {
			...
			this.element.addClass( "ui-tools-hidden-accessible" );
	...
	_destroy: function() {
		this.element
			.removeClass( "ui-tools-hidden-accessible" );
		this.buttonElement
      ...
      self.$container.on('click', $.proxy(function(event) {
        ...
        if (self.options.addOnBlur && self.options.freeInput) {
          self.$input.on('focusout', $.proxy(function(event) {
              // HACK: only procedure on focusout when no typeahead opened, to
   ...
   */
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        updateResults: function (initial) {
            ...
            // give the tokenizer a chance to pre-procedure the input
            input = this.tokenize();
